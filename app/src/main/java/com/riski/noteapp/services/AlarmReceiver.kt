package com.riski.noteapp.services
...
import com.riski.noteapp.ui.MainActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun showAlarmNotification(context: Context, title: String, message: String, notifId: Int) {
        ...
        val pendingIntent = PendingIntent.getActivity(context, ID_REPEATING, Intent(context, MainActivity::class.java), 0)
        val builder = NotificationCompat.Builder(context, channelId)
            .setSmallIcon(R.drawable.ic_baseline_access_time_black)
